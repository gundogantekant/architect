...
16 specialized agents organized in 5 categories. The main Claude conversation orchestrates them — subagents cannot spawn other subagents.
...
Read-only agents (reviewer, security-auditor, performance) do not modify files. Implementation agents (coder-*) have file write access.

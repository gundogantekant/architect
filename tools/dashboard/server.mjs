...
import { resolveProjectPath, resolveOrgPath, loadPortfolioContext, loadOrgContext, loadWorkItem, topoSort, loadEpicPlanSnippet, selectAgentsForDispatch, buildDispatchPrompt, buildAutoImplementPrompt } from './prompt-builder.mjs';
...
const deps = {
  ...
  buildDispatchPrompt, buildAutoImplementPrompt, resolveProjectPath, resolveOrgPath, loadPortfolioContext, loadOrgContext, loadWorkItem, selectAgentsForDispatch, loadEpicPlanSnippet,

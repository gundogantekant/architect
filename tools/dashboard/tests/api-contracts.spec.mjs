...
test.describe('API contracts @fast', () => {
  ...
  test('AC-2: GET /api/work-items returns array', async () => {
    const result = await api('work-items?project_key=ticari/architect/main');
  ...
  test('AC-5: DELETE /api/work-items/:id removes item', async () => {
    ...
    const list = await api('work-items?project_key=ticari/architect/main');
  ...
  test('AC-9: GET /api/server/status returns running', async () => {

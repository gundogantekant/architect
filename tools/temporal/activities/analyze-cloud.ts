...
export interface AnalyzeCloudInput {
  requirement: string;
  projectKey: string;
...
export async function analyzeCloudImpact(input: AnalyzeCloudInput): Promise<CloudAnalysis> {
  ...
  const prompt = `Analyze cloud infrastructure impact for this requirement.
